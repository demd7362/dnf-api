...
import com.taecho.dnfbackend.referer.service.UserReferersService
...
class RouteController(
    private val dnfApiService: DnfApiService,
    private val userReferersService: UserReferersService
) {
    // JvmStatic -> java static 처럼 사용
    // JvmField -> public으로 만들고 getter , setter 없이 직접 접근
    @GetMapping("/")
    fun indexRouter(): String {
        userReferersService.saveReferer()
        return "index"
    }
